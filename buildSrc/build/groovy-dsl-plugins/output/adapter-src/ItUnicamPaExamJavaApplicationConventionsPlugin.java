...
/**
 * Precompiled it.unicam.pa.exam.java-application-conventions script plugin.
 **/
public class ItUnicamPaExamJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ItUnicamPaExamJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("it.unicam.pa.exam.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ItUnicamPaExamJavaApplicationConventions").asSubclass(BasicScript.class);
